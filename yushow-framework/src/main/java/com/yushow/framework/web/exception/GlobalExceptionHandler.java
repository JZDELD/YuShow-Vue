package com.yushow.framework.web.exception;

import com.yushow.common.core.api.AjaxResult;
import com.yushow.common.enums.ApiErrorCode;
import com.yushow.common.exception.DemoModeException;
...
public class GlobalExceptionHandler {
    ...
    public AjaxResult<Void> handleAccessDeniedException(AccessDeniedException e, HttpServletRequest request) {
        ...
        return AjaxResult.failed(ApiErrorCode.NO_PERMISSION.getCode(), "没有权限，请联系管理员授权");
    }
    ...
    public AjaxResult<Void> handleDemoModeException(DemoModeException e) {
        return AjaxResult.failed("演示模式，不允许操作");
    }
}
