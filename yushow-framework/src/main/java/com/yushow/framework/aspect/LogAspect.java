package com.yushow.framework.aspect;

import com.alibaba.fastjson.JSON;
import com.yushow.common.annotation.Log;
import com.yushow.common.core.domain.model.LoginUser;
import com.yushow.common.enums.BusinessStatus;
...
public class LogAspect {
    ...
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log, SysOperLog operLog, Object jsonResult) throws Exception {
        ...
        // 是否需要保存response，参数和值
        if (log.isSaveResponseData() && com.yushow.common.utils.StringUtils.isNotNull(jsonResult)) {
